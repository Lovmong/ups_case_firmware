...
#define ki 0.0
#define kd 0.4
#define targetVoltage 4950
#define maxValue 1500

#define BATTERY_VOLTAGE_CHANNEL 07 // 0x07
#define BATTERY_CURRENT_CHANNEL 10 // 0x0A
#define USB_VOLTAGE_CHANNEL 6      // 0x06
#define OUTPUT_CURRENT_CHANNEL 11  // 0x0B
